...
public final class RenderUtils {
    ...
    public static void scaledProjection() {
        RenderSystem.setProjectionMatrix(new Matrix4f().setOrtho(0.0f, (float) (Gamble.mc.getWindow().getFramebufferWidth() / Gamble.mc.getWindow().getScaleFactor()), (float) (Gamble.mc.getWindow().getFramebufferHeight() / Gamble.mc.getWindow().getScaleFactor()), 0.0f, 1000.0f, 21000.0f), RenderUtils.vertexSorter);
